    ...
    <Section id='about'>
      ...
      <SectionText>
        ...
        <Img src='/me.png' alt="Israel Brach's profile picture" />
          ...
          in Software Engineering from Touro University in New York, graduating in 2022.
      </SectionText>
      <SectionText>
      ...
      <SectionText>
        I live in New York City. Some of my hobbies include 3D Printing, playing video games, cooking, general tinkering, and traveling.
      </SectionText>
      <br />
      <br />
      <SectionDivider />
